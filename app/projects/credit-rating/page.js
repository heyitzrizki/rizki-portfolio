...
export default function CreditRatingPage() {
  const project = projects.find((p) => p.slug === "credit-rating");
      ...
      <section className="max-w-4xl mx-auto px-6 py-16 space-y-12">
        ...
        <section>
          ...
          <ul className="space-y-3 text-gray-700 leading-7">
            <li>• Predict borrower probability of default (PD)</li>
            <li>• Translate predictions into Approve / Review / Reject decisions</li>
            <li>• Provide explainability with SHAP and temporal attention</li>
            <li>• Support portfolio monitoring and risk segmentation</li>
          </ul>
        </section>
